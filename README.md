...
- **UPDATE**: Використовується для зміни значень у існуючих записах таблиці.
- **DELETE**: Використовується для видалення записів із таблиці.

Обидві команди є важливими інструментами для підтримки актуальності та чистоти даних у базі даних, але їх слід використовувати з обережністю, щоб уникнути випадкових втрат або небажаних змін даних.
